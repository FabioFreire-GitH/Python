#DESAFIO 021: Crie a classe ControleRemoto, onde vamos simular o funcionamento de um controle simples (canal, volume e liga/desliga)
...
while True:
    system('cls')
    c.mostrar_tv()
    comando = str(input(f" @ on/off  < CH >  - VOL + "))
    match comando:
        case '0':
            break
        case '@':
